namespace GnomeCrawler.Enemy
{
    public class EnemyStateFactory
    {
        ...
        public EnemyStateFactory(EnemyStateManager currentContext) { context = currentContext; }

        public EnemyBaseState IdleState() { return new EnemyIdleState(context, this); }
